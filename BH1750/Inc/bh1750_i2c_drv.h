...
uint8_t BH1750_Send_Cmd(BH1750_MODE cmd);	//向BH1750发送一条指令
uint8_t BH1750_Read_Dat(uint8_t* dat);		//从BH1750接收一次光强数据
uint16_t BH1750_Dat_To_Lux(uint8_t* dat);	//将BH1750的两个字节数据转换为光照强度值(0-65535)
uint16_t BH1750_Get_LuxValue(uint8_t* dat);	//从
